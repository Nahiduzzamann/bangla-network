...
const OurCompany = () => {
    return (
        ...
        //                 <Parallax bgImage="https://i.ibb.co/D7JLDqz/IMG-1629.jpg" strength={500}>
        ...
        //                                             <img class="h-40 w-40 drop-shadow-2xl rounded-[60px] shadow-2xl" src="https://images.unsplash.com/photo-1548174753-897b449b097e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1169&q=80" alt="" />
        //                                         </div>
        //                                         <div>
        //                                             <img class="h-60 w-60 drop-shadow-2xl rounded-[60px] shadow-2xl" src="https://images.unsplash.com/photo-1564038057903-1d48b852b412?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="" />
        //                                         </div>
        //                                         <div className="flex justify-center">
        //                                             <img class="h-60 w-60 drop-shadow-2xl rounded-[60px] shadow-2xl" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNYW2VNCva-76r3x-xJKugBl0IwODi3wpWWT-0RMboMNB9JfijhGGxo8x_K3w-FLu0-eA&usqp=CAU" alt="" />
        //                                         </div>
        //                                         <div>
        //                                             <img class="h-60 w-60 drop-shadow-2xl rounded-[60px] shadow-2xl" src="https://img.freepik.com/premium-photo/tech-devices-icons-connected-digital-planet-earth_117023-449.jpg" alt="" />
        //                                         </div>
        //                                     </div>
        //                                 </div>
        //                                 <div class="lg:w-1/2 mt-12 lg:mt-0 lg:pl-12">
        //                                     <h2 class="text-3xl font-bold mb-4 text-white">There are several reasons why you should choose our company. Here are a few key points:</h2>
