...
const Services = () => {
    ...
    return (
        <div>
            <h3 className="text-center text-4xl mt-10 lg:mt-24 text-orange-500">Our Services</h3>
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="flex flex-wrap justify-center">
                            {services.map((service, index) => (
                                ...
                                >
                                    <div className="p-6 bg-gray-600 rounded-lg shadow hover:bg-gray-900 hover:shadow-lg transform hover:scale-110 transition-all duration-500 h-full overflow-hidden">
                                        ...
                                        <p className={`text-gray-400  ${expanded ? '' : 'truncate'}`}>
                                            {service.description}
                                        </p>
