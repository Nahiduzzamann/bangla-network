  ...
  const data = [
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faWifi} />
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faNetworkWired} />
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faBrain} />
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faGlobe} />
    },
    {
      title: "IP phone",
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faPhone} />
    },
    {
      title: "Wi-Fi",
    ...
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faShoppingCart} />
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faHeadset} />
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faBroadcastTower} />
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faWalking} />
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faBuilding} />
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faTools} />
    },
    {
      title: "Research",
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faFlask} />
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faServer} />
    },
    {
      title: "Broadcasting",
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faFile} />
    },
    {
    ...
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faVideo} />
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faSatelliteDish} />
    },
    {
      ...
      icon: <FontAwesomeIcon size="3x" color="#DD6B20" icon={faCogs} />
    }
  ];
